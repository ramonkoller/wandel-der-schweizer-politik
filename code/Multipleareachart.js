...
var changeAreas = function(d){
            if (selectedPartei != "Uebrige") {
                ...
                document.getElementById('multiple-plots').remove();
                var div = document.createElement('div');
                div.setAttribute('id', 'multiple-plots');
                document.querySelector('#multiplePlots').appendChild(div);
                areaplotMultiple(plotCantonBarplot);
            } else {
            }
}
    
// multiple areaplots will appear
function areaplotMultiple(plotCantonBarplot) {
    ...
    for (var i in plotCantonBarplot){
        if (plotCantonBarplot[i] == "St-Gallen"){
            pCanton = "St. Gallen";
        } else if (plotCantonBarplot[i] == "Appenzell-Innerrhoden"){
            pCanton = "Appenzell I. Rh.";
        } else if (plotCantonBarplot[i] == "Appenzell-Ausserrhoden"){
            pCanton = "Appenzell A. Rh.";
        } else {
            pCanton = plotCantonBarplot[i];
        }
        ...
        var plot = d3.select("#multiple-plots")
            .append("svg")
        ...
        var plotTooltip = d3.select("#multiple-plots")
            .append("div")
            .style("opacity", 0)
            .attr("class", "tooltip")
        ...
        plot.selectAll("myrect")
            ...
            .attr("r", 6)
            .attr("cx", 360)
            .attr("cy", function(d,i){ return 206 - i * 25})
        ...
        plot.selectAll("mylabels")
            ...
            .append("text")
            .attr("x", 360 + 13)
            .attr("y", function(d,i){ return 210 - i *25})
